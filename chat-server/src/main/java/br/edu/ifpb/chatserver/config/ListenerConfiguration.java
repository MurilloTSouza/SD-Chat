package br.edu.ifpb.chatserver.config;
...
public class ListenerConfiguration {
    ...
    public Map<String, Object> consumerConfigurations() {
        ...
        configurations.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KafkaConstants.KAFKA_SERVER_IP);
        configurations.put(ConsumerConfig.GROUP_ID_CONFIG, KafkaConstants.KAFKA_GROUP);
